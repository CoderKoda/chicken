/* Generated from chicken.sort.import.scm by the CHICKEN compiler
   ...
   command line: chicken.sort.import.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -feature debugbuild -verbose -specialize -consult-types-file ./types.db -feature chicken-compile-shared -dynamic -no-trace -output-file chicken.sort.import.c
   uses: eval library
*/
#include "chicken.h"
...
{C_text("f_121:chicken_2esort_2eimport_2escm"),(void*)f_121},
{C_text("f_124:chicken_2esort_2eimport_2escm"),(void*)f_124},
{C_text("f_127:chicken_2esort_2eimport_2escm"),(void*)f_127},
{C_text("f_129:chicken_2esort_2eimport_2escm"),(void*)f_129},
