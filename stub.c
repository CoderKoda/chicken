/* Generated from stub.scm by the CHICKEN compiler
   ...
   command line: stub.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -feature debugbuild -verbose -specialize -consult-types-file ./types.db -explicit-use -no-trace -output-file stub.c
   unit: default_stub
...
static C_char li0[] C_aligned={C_lihdr(0,0,6),40,108,111,111,112,41,0,0};
...
C_noret_decl(f_155)
static void f_155(C_word t0,C_word t1) C_noret;
C_noret_decl(f_159)
static void C_ccall f_159(C_word c,C_word *av) C_noret;
C_noret_decl(C_default_5fstub_toplevel)
C_extern void C_ccall C_default_5fstub_toplevel(C_word c,C_word *av) C_noret;

C_noret_decl(trf_155)
static void C_ccall trf_155(C_word c,C_word *av) C_noret;
static void C_ccall trf_155(C_word c,C_word *av){
C_word t0=av[1];
C_word t1=av[0];
f_155(t0,t1);}
...
t6=C_set_block_item(t5,0,(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_155,a[2]=t5,a[3]=((C_word)li0),tmp=(C_word)a,a+=4,tmp));
t7=((C_word*)t5)[1];
f_155(t7,t3);}
...
/* loop in k148 in k145 in k142 in k139 in k136 */
static void f_155(C_word t0,C_word t1){
C_word tmp;
C_word t2;
C_word t3;
C_word *a;
...
C_save_and_reclaim_args((void *)trf_155,2,t0,t1);}
a=C_alloc(4);
t2=(*a=C_CLOSURE_TYPE|3,a[1]=(C_word)f_159,a[2]=((C_word*)t0)[2],a[3]=t1,tmp=(C_word)a,a+=4,tmp);
...
/* k157 in loop in k148 in k145 in k142 in k139 in k136 */
...
{C_text("f_150:stub_2escm"),(void*)f_150},
{C_text("f_153:stub_2escm"),(void*)f_153},
{C_text("f_155:stub_2escm"),(void*)f_155},
{C_text("f_159:stub_2escm"),(void*)f_159},
