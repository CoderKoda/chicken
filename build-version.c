/* Generated from build-version.scm by the CHICKEN compiler
   ...
   command line: build-version.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -feature debugbuild -verbose -specialize -consult-types-file ./types.db -explicit-use -no-trace -output-file build-version.c
   unit: build-version
*/
#include "chicken.h"
...
lf[2]=C_decode_literal(C_heaptop,C_text("\376\002\000\000\011\062\145\063\060\143\060\067\145\000"));
lf[3]=C_h_intern(&lf[3],18, C_text("##sys#build-branch"));
lf[4]=C_h_intern(&lf[4],19, C_text("##sys#build-version"));
lf[5]=C_decode_literal(C_heaptop,C_text("\376\002\000\000\006\066\056\060\056\060\000"));
