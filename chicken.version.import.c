/* Generated from chicken.version.import.scm by the CHICKEN compiler
   http://www.call-cc.org
   Version 6.0.0 (rev eeeb4bfb)
   openbsd-unix-clang-x86-64 [ 64bit dload ptables ]
   command line: chicken.version.import.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -feature debugbuild -verbose -specialize -consult-types-file ./types.db -feature chicken-compile-shared -dynamic -no-trace -output-file chicken.version.import.c
   uses: eval library
*/
#include "chicken.h"
...
if(C_unlikely(!C_demand_2(48))){
C_save(t1);
C_rereclaim2(48*sizeof(C_word),1);
t1=C_restore;}
a=C_alloc(3);
C_initialize_lf(lf,5);
lf[0]=C_h_intern(&lf[0],30, C_text("##sys#register-compiled-module"));
lf[1]=C_h_intern(&lf[1],15, C_text("chicken.version"));
lf[2]=C_h_intern(&lf[2],6, C_text("extras"));
lf[3]=C_decode_literal(C_heaptop,C_text("\376\003\000\000\002\376\003\000\000\002\376\001\000\000\012\001\166\145\162\163\151\157\156\076\075\077\376\001\000\000\032\001\143\150\151\143\153\145\156\056\166\145\162\163\151\157\156\043\166\145\162\163\151\157\156\076\075\077\376\377\016"));
...
{C_text("f_121:chicken_2eversion_2eimport_2escm"),(void*)f_121},
{C_text("f_124:chicken_2eversion_2eimport_2escm"),(void*)f_124},
{C_text("f_127:chicken_2eversion_2eimport_2escm"),(void*)f_127},
{C_text("f_129:chicken_2eversion_2eimport_2escm"),(void*)f_129},
{C_text("toplevel:chicken_2eversion_2eimport_2escm"),(void*)C_toplevel},
{NULL,NULL}};
#endif
