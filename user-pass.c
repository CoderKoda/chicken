/* Generated from user-pass.scm by the CHICKEN compiler
   ...
   command line: user-pass.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -feature debugbuild -verbose -specialize -consult-types-file ./types.db -no-lambda-info -emit-import-library chicken.compiler.user-pass -output-file user-pass.c
   unit: user-pass
   uses: eval library
*/
#include "chicken.h"
...
t4=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_145,a[2]=((C_word*)t0)[2],tmp=(C_word)a,a+=3,tmp);
C_trace(C_text("user-pass.scm:37: scheme#make-parameter"));
...
C_trace(C_text("user-pass.scm:38: scheme#make-parameter"));
...
C_trace(C_text("user-pass.scm:39: scheme#make-parameter"));
t4=C_fast_retrieve(lf[7]);{
C_word *av2;
if(c >= 3) {
  av2=av;
...
/* k151 in k147 in k143 in k139 in k136 */
...
C_trace(C_text("user-pass.scm:40: scheme#make-parameter"));
t4=C_fast_retrieve(lf[7]);{
C_word *av2;
if(c >= 3) {
  av2=av;
...
/* k155 in k151 in k147 in k143 in k139 in k136 */
...
t3=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_161,a[2]=((C_word*)t0)[2],tmp=(C_word)a,a+=3,tmp);
C_trace(C_text("user-pass.scm:41: scheme#make-parameter"));
t4=C_fast_retrieve(lf[7]);{
C_word *av2;
if(c >= 3) {
  av2=av;
...
/* k159 in k155 in k151 in k147 in k143 in k139 in k136 */
...
lf[7]=C_h_intern(&lf[7],21, C_text("scheme#make-parameter"));
...
{C_text("f_161:user_2dpass_2escm"),(void*)f_161},
