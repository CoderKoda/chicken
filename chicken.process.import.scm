  ...
  (lambda ()
    (##sys#register-compiled-module
      ...
      '((qs . chicken.process#qs)
        ...
        (process? . chicken.process#process?)
        (process-exit-status . chicken.process#process-exit-status)
        (process-returned-normally?
          .
          chicken.process#process-returned-normally?)
        (process-input-port . chicken.process#process-input-port)
        (process-output-port . chicken.process#process-output-port)
        (process-error-port . chicken.process#process-error-port)
        (process-id . chicken.process#process-id))
      (scheme#list)
      (scheme#list)
      (scheme#list))))
