;;;; chicken.port.import.scm - GENERATED BY CHICKEN 6.0.0 -*- Scheme -*-
  ...
  (lambda ()
    (##sys#register-compiled-module
      ...
      '((call-with-input-string . chicken.port#call-with-input-string)
        ...
        (make-binary-input-port . chicken.port#make-binary-input-port)
        (make-output-port . chicken.port#make-output-port)
        (make-binary-output-port . chicken.port#make-binary-output-port)
        (port-encoding . chicken.port#port-encoding)
