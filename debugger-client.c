/* Generated from debugger-client.scm by the CHICKEN compiler
   ...
   command line: debugger-client.scm -optimize-level 2 -include-path . -include-path ./ -inline -ignore-repository -feature chicken-bootstrap -feature debugbuild -verbose -specialize -consult-types-file ./types.db -explicit-use -no-trace -output-file debugger-client.c
...
C_extern void C_ccall C_debugger_2dclient_toplevel(C_word c,C_word *av) C_noret;
